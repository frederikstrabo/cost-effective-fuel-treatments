...
### `ACS/` contents
- `ACS/nhgis0003_shape/` — shapefiles of 2020 Census blocks  
- `ACS/nhgis0003_csv/` — CSVs of ACS 2013–2017, …, 2018–2022 surveys with median housing values by census block
